...
class GameFormValidator(private val entityId: Int?) : FormValidator() {
    ...
    override fun defineActionValidations(): Map<String, (formData: Map<String, ControlResultData>) -> Boolean> {
        return mapOf(
     ...
     */
    private fun checkTitleUniqueness(formData: Map<String, ControlResultData>): Boolean {
